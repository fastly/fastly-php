...
class LoggingSftpApi
{
     ...
     */
    public function createLogSftp($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = 'classic', $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $address = null, $port = 22, $password = null, $path = 'null', $public_key = 'null', $secret_key = 'null', $ssh_known_hosts = null, $user = null)
    {
     ...
     */
    public function createLogSftpWithHttpInfo($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = 'classic', $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $address = null, $port = 22, $password = null, $path = 'null', $public_key = 'null', $secret_key = 'null', $ssh_known_hosts = null, $user = null)
    {
     ...
     */
    public function createLogSftpAsync($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = 'classic', $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $address = null, $port = 22, $password = null, $path = 'null', $public_key = 'null', $secret_key = 'null', $ssh_known_hosts = null, $user = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createLogSftpAsyncWithHttpInfo($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = 'classic', $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $address = null, $port = 22, $password = null, $path = 'null', $public_key = 'null', $secret_key = 'null', $ssh_known_hosts = null, $user = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineObject';
        $request = $this->createLogSftpRequest($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $address, $port, $password, $path, $public_key, $secret_key, $ssh_known_hosts, $user);
     ...
     */
    public function createLogSftpRequest($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = 'classic', $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $address = null, $port = 22, $password = null, $path = 'null', $public_key = 'null', $secret_key = 'null', $ssh_known_hosts = null, $user = null)
    {
     ...
     */
    public function updateLogSftp($service_id, $version_id, $logging_sftp_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = FORMAT_VERSION_2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = MESSAGE_TYPE_CLASSIC, $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $address = null, $port = 22, $password = null, $path = 'null', $public_key = 'null', $secret_key = 'null', $ssh_known_hosts = null, $user = null)
    {

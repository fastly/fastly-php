...
```php
createLogSftp($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $address, $port, $password, $path, $public_key, $secret_key, $ssh_known_hosts, $user): \OpenAPI\Client\Model\InlineObject
```
...
```php
deleteLogSftp($service_id, $version_id, $logging_sftp_name): object
```
...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_sftp_name = log-endpoint-name; // string

try {
    $result = $apiInstance->deleteLogSftp($service_id, $version_id, $logging_sftp_name);
    print_r($result);
} catch (Exception $e) {
...
```php
getLogSftp($service_id, $version_id, $logging_sftp_name): \OpenAPI\Client\Model\InlineObject
```
...
try {
    $result = $apiInstance->getLogSftp($service_id, $version_id, $logging_sftp_name);
    print_r($result);
} catch (Exception $e) {
...
```php
listLogSftp($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
try {
    $result = $apiInstance->listLogSftp($service_id, $version_id);
    print_r($result);
} catch (Exception $e) {
...
```php
updateLogSftp($service_id, $version_id, $logging_sftp_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $address, $port, $password, $path, $public_key, $secret_key, $ssh_known_hosts, $user): \OpenAPI\Client\Model\InlineObject1
```
...
try {
    $result = $apiInstance->updateLogSftp($service_id, $version_id, $logging_sftp_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $address, $port, $password, $path, $public_key, $secret_key, $ssh_known_hosts, $user);
    print_r($result);
} catch (Exception $e) {

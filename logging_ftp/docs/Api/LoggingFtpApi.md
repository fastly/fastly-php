...
```php
createLogFtp($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $address, $hostname, $ipv4, $password, $path, $port, $public_key, $user): \OpenAPI\Client\Model\InlineObject
```
...
$apiInstance = new OpenAPI\Client\Api\LoggingFtpApi(
...
try {
    $result = $apiInstance->createLogFtp($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $address, $hostname, $ipv4, $password, $path, $port, $public_key, $user);
    print_r($result);
} catch (Exception $e) {
...
```php
deleteLogFtp($service_id, $version_id, $logging_ftp_name): object
```
...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_ftp_name = log-endpoint-name; // string

try {
    $result = $apiInstance->deleteLogFtp($service_id, $version_id, $logging_ftp_name);
    print_r($result);
} catch (Exception $e) {
...
```php
getLogFtp($service_id, $version_id, $logging_ftp_name): \OpenAPI\Client\Model\InlineObject
```
...
try {
    $result = $apiInstance->getLogFtp($service_id, $version_id, $logging_ftp_name);
    print_r($result);
} catch (Exception $e) {
...
```php
listLogFtp($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
try {
    $result = $apiInstance->listLogFtp($service_id, $version_id);
    print_r($result);
} catch (Exception $e) {
...
```php
updateLogFtp($service_id, $version_id, $logging_ftp_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $address, $hostname, $ipv4, $password, $path, $port, $public_key, $user): \OpenAPI\Client\Model\InlineObject1
```

...
```php
createLogGcs($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $user, $secret_key, $bucket_name, $path, $public_key): \OpenAPI\Client\Model\InlineObject
```
...
```php
deleteLogGcs($service_id, $version_id, $logging_gcs_name): object
```
...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_gcs_name = log-endpoint-name; // string

try {
    $result = $apiInstance->deleteLogGcs($service_id, $version_id, $logging_gcs_name);
    print_r($result);
} catch (Exception $e) {
...
```php
getLogGcs($service_id, $version_id, $logging_gcs_name): \OpenAPI\Client\Model\InlineObject
```
...
try {
    $result = $apiInstance->getLogGcs($service_id, $version_id, $logging_gcs_name);
    print_r($result);
} catch (Exception $e) {
...
```php
listLogGcs($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
try {
    $result = $apiInstance->listLogGcs($service_id, $version_id);
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->updateLogGcs($service_id, $version_id, $logging_gcs_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $user, $secret_key, $bucket_name, $path, $public_key);
    print_r($result);
} catch (Exception $e) {

...
```php
createLogPapertrail($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $address, $port): \OpenAPI\Client\Model\InlineObject
```
...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_papertrail_name = log-endpoint-name; // string
...
```php
getLogPapertrail($service_id, $version_id, $logging_papertrail_name): \OpenAPI\Client\Model\InlineObject
```
...
```php
listLogPapertrail($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
```php
updateLogPapertrail($service_id, $version_id, $logging_papertrail_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $address, $port): \OpenAPI\Client\Model\InlineObject1
```

...
/**
 * ModelDirector Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelDirector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_director';
    ...
    protected static $openAPITypes = [
        ...
        'service_id' => 'string',
        'version' => 'int',
        'backends' => '\OpenAPI\Client\Model\ServiceServiceIdVersionVersionIdDirectorBackends[]',
        'capacity' => 'int',
        'comment' => 'string',
        'name' => 'string',
        'quorum' => 'int',
     ...
     * Gets backends
     *
     * @return \OpenAPI\Client\Model\ServiceServiceIdVersionVersionIdDirectorBackends[]|null
     */
     ...
     * Sets backends
     *
     * @param \OpenAPI\Client\Model\ServiceServiceIdVersionVersionIdDirectorBackends[]|null $backends List of backends associated to a director.
     *
     * @return self
     */
    ...
    public function setQuorum($quorum)
    {
        ...
        if (!is_null($quorum) && ($quorum > 100)) {
            throw new \InvalidArgumentException('invalid value for $quorum when calling ModelDirector., must be smaller than or equal to 100.');
        }
        if (!is_null($quorum) && ($quorum < 0)) {
            throw new \InvalidArgumentException('invalid value for $quorum when calling ModelDirector., must be bigger than or equal to 0.');
        }

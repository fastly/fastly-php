...
**backends** | [**\OpenAPI\Client\Model\ServiceServiceIdVersionVersionIdDirectorBackends[]**](ServiceServiceIdVersionVersionIdDirectorBackends.md) | List of backends associated to a director. | [optional]
...
**type** | **int** | What type of load balance group to use. | [optional] [default to TYPE_1]

...
/**
 * UtilsContentApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class UtilsContentApi
{
     ...
     * @return void
     */
    public function contentCheck($url = null)
    {
        $this->contentCheckWithHttpInfo($url);
    }
     ...
     */
    public function contentCheckWithHttpInfo($url = null)
    {
        $request = $this->contentCheckRequest($url);
     ...
     */
    public function contentCheckAsync($url = null)
    {
        return $this->contentCheckAsyncWithHttpInfo($url)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function contentCheckAsyncWithHttpInfo($url = null)
    {
        $returnType = '';
        $request = $this->contentCheckRequest($url);
     ...
     */
    public function contentCheckRequest($url = null)
    {

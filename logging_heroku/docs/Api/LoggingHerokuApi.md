# OpenAPI\Client\LoggingHerokuApi
...
```php
createLogHeroku($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token, $url): \OpenAPI\Client\Model\InlineObject
```
...
$apiInstance = new OpenAPI\Client\Api\LoggingHerokuApi(
...
try {
    $result = $apiInstance->createLogHeroku($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token, $url);
    print_r($result);
} catch (Exception $e) {
...
```php
deleteLogHeroku($service_id, $version_id, $logging_heroku_name): object
```
...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_heroku_name = log-endpoint-name; // string

try {
    $result = $apiInstance->deleteLogHeroku($service_id, $version_id, $logging_heroku_name);
    print_r($result);
} catch (Exception $e) {
...
```php
getLogHeroku($service_id, $version_id, $logging_heroku_name): \OpenAPI\Client\Model\InlineObject
```
...
try {
    $result = $apiInstance->getLogHeroku($service_id, $version_id, $logging_heroku_name);
    print_r($result);
} catch (Exception $e) {
...
```php
listLogHeroku($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
try {
    $result = $apiInstance->listLogHeroku($service_id, $version_id);
    print_r($result);
} catch (Exception $e) {
...
```php
updateLogHeroku($service_id, $version_id, $logging_heroku_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token, $url): \OpenAPI\Client\Model\InlineObject1
```
...
try {
    $result = $apiInstance->updateLogHeroku($service_id, $version_id, $logging_heroku_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token, $url);
    print_r($result);
} catch (Exception $e) {

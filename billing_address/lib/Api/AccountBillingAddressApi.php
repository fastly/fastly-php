...
/**
 * AccountBillingAddressApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccountBillingAddressApi
{
    /**
     * @var ClientInterface
     */
     ...
     */
    public function addBillingAddr($customer_id, $inline_object = null)
    {
        list($response) = $this->addBillingAddrWithHttpInfo($customer_id, $inline_object);
        return $response;
    }
     ...
     */
    public function addBillingAddrWithHttpInfo($customer_id, $inline_object = null)
    {
        $request = $this->addBillingAddrRequest($customer_id, $inline_object);
     ...
     */
    public function addBillingAddrAsync($customer_id, $inline_object = null)
    {
        return $this->addBillingAddrAsyncWithHttpInfo($customer_id, $inline_object)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addBillingAddrAsyncWithHttpInfo($customer_id, $inline_object = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse200';
        $request = $this->addBillingAddrRequest($customer_id, $inline_object);
     ...
     */
    public function addBillingAddrRequest($customer_id, $inline_object = null)
    {
     ...
     * @return \OpenAPI\Client\Model\InlineResponse200
     */
    public function updateBillingAddr($customer_id, $inline_object1 = null)
    {
        list($response) = $this->updateBillingAddrWithHttpInfo($customer_id, $inline_object1);
        return $response;
    }
     ...
     * @return array of \OpenAPI\Client\Model\InlineResponse200, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBillingAddrWithHttpInfo($customer_id, $inline_object1 = null)
    {
        $request = $this->updateBillingAddrRequest($customer_id, $inline_object1);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBillingAddrAsync($customer_id, $inline_object1 = null)
    {
        return $this->updateBillingAddrAsyncWithHttpInfo($customer_id, $inline_object1)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBillingAddrAsyncWithHttpInfo($customer_id, $inline_object1 = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse200';
        $request = $this->updateBillingAddrRequest($customer_id, $inline_object1);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateBillingAddrRequest($customer_id, $inline_object1 = null)
    {
        // verify the required parameter 'customer_id' is set
        if ($customer_id === null || (is_array($customer_id) && count($customer_id) === 0)) {
            throw new \InvalidArgumentException(

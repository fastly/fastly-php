# OpenAPI\Client\ServicesBackendApi
...
```php
createBackend($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200
```
...
try {
    ...
    echo 'Exception when calling ServicesBackendApi->deleteBackend: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getBackend($service_id, $version_id, $backend_name): \OpenAPI\Client\Model\InlineResponse200
```
...
try {
    ...
    echo 'Exception when calling ServicesBackendApi->getBackend: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
listBackends($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
try {
    ...
    echo 'Exception when calling ServicesBackendApi->listBackends: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateBackend($service_id, $version_id, $backend_name): \OpenAPI\Client\Model\InlineResponse200
```
...
try {
    ...
    echo 'Exception when calling ServicesBackendApi->updateBackend: ', $e->getMessage(), PHP_EOL;
}
```

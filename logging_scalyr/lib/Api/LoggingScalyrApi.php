...
class LoggingScalyrApi
{
     ...
     */
    public function createLogScalyr($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = 'US', $token = null, $project_id = 'logplex')
    {
     ...
     */
    public function createLogScalyrWithHttpInfo($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = 'US', $token = null, $project_id = 'logplex')
    {
     ...
     */
    public function createLogScalyrAsync($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = 'US', $token = null, $project_id = 'logplex')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createLogScalyrAsyncWithHttpInfo($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = 'US', $token = null, $project_id = 'logplex')
    {
        $returnType = '\OpenAPI\Client\Model\InlineObject';
        $request = $this->createLogScalyrRequest($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $region, $token, $project_id);
     ...
     */
    public function createLogScalyrRequest($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = 2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = 'US', $token = null, $project_id = 'logplex')
    {
     ...
     */
    public function updateLogScalyr($service_id, $version_id, $logging_scalyr_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = FORMAT_VERSION_2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = REGION_US, $token = null, $project_id = 'logplex')
    {
     ...
     */
    public function updateLogScalyrWithHttpInfo($service_id, $version_id, $logging_scalyr_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = FORMAT_VERSION_2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = REGION_US, $token = null, $project_id = 'logplex')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLogScalyrAsync($service_id, $version_id, $logging_scalyr_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = FORMAT_VERSION_2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = REGION_US, $token = null, $project_id = 'logplex')
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateLogScalyrRequest($service_id, $version_id, $logging_scalyr_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = FORMAT_VERSION_2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $region = REGION_US, $token = null, $project_id = 'logplex')
    {
        // verify the required parameter 'service_id' is set
        if ($service_id === null || (is_array($service_id) && count($service_id) === 0)) {
            throw new \InvalidArgumentException(

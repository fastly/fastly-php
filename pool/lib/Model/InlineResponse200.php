...
class InlineResponse200 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setQuorum($quorum)
    {
        ...
        if (!is_null($quorum) && ($quorum > 100)) {
            throw new \InvalidArgumentException('invalid value for $quorum when calling InlineResponse200., must be smaller than or equal to 100.');
        }
        if (!is_null($quorum) && ($quorum < 0)) {
            throw new \InvalidArgumentException('invalid value for $quorum when calling InlineResponse200., must be bigger than or equal to 0.');
        }

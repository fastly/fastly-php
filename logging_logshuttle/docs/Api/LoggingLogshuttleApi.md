# OpenAPI\Client\LoggingLogshuttleApi
...
```php
createLogLogshuttle($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token, $url): \OpenAPI\Client\Model\InlineObject
```
...
```php
deleteLogLogshuttle($service_id, $version_id, $logging_logshuttle_name): object
```
...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_logshuttle_name = log-endpoint-name; // string

try {
    $result = $apiInstance->deleteLogLogshuttle($service_id, $version_id, $logging_logshuttle_name);
    print_r($result);
} catch (Exception $e) {
...
```php
getLogLogshuttle($service_id, $version_id, $logging_logshuttle_name): \OpenAPI\Client\Model\InlineObject
```
...
try {
    $result = $apiInstance->getLogLogshuttle($service_id, $version_id, $logging_logshuttle_name);
    print_r($result);
} catch (Exception $e) {
...
```php
listLogLogshuttle($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
try {
    $result = $apiInstance->listLogLogshuttle($service_id, $version_id);
    print_r($result);
} catch (Exception $e) {
...
```php
updateLogLogshuttle($service_id, $version_id, $logging_logshuttle_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token, $url): \OpenAPI\Client\Model\InlineObject1
```
...
try {
    $result = $apiInstance->updateLogLogshuttle($service_id, $version_id, $logging_logshuttle_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token, $url);
    print_r($result);
} catch (Exception $e) {

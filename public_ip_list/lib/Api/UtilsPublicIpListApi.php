...
/**
 * UtilsPublicIpListApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class UtilsPublicIpListApi
{
     ...
     * @return void
     */
    public function listFastlyIps()
    {
        $this->listFastlyIpsWithHttpInfo();
    }
     ...
     */
    public function listFastlyIpsWithHttpInfo()
    {
        $request = $this->listFastlyIpsRequest();
     ...
     */
    public function listFastlyIpsAsync()
    {
        return $this->listFastlyIpsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listFastlyIpsAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->listFastlyIpsRequest();
     ...
     */
    public function listFastlyIpsRequest()
    {

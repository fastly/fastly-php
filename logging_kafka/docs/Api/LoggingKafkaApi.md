...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_kafka_name = log-endpoint-name; // string
...
```php
getLogKafka($service_id, $version_id, $logging_kafka_name): \OpenAPI\Client\Model\InlineObject
```
...
```php
listLogKafka($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
```php
updateLogKafka($service_id, $version_id, $logging_kafka_name): \OpenAPI\Client\Model\InlineObject
```

...
/**
 * SchemasDirector Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
...
class SchemasDirector implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'schemas-director';
    ...
    public function setQuorum($quorum)
    {
        ...
        if (!is_null($quorum) && ($quorum > 100)) {
            throw new \InvalidArgumentException('invalid value for $quorum when calling SchemasDirector., must be smaller than or equal to 100.');
        }
        if (!is_null($quorum) && ($quorum < 0)) {
            throw new \InvalidArgumentException('invalid value for $quorum when calling SchemasDirector., must be bigger than or equal to 0.');
        }

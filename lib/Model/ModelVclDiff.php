...
/**
 * ModelVclDiff Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelVclDiff implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_vcl_diff';
     ...
     * Sets format
     *
     * @param string|null $format The format in which compared VCL changes are being returned in. Valid values are `text`, `html`, or `html_simple`.
     *
     * @return self
     */

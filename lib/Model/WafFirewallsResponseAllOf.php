...
/**
 * WafFirewallsResponseAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class WafFirewallsResponseAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'waf_firewalls_response_allOf';
     ...
     * Gets included
     *
     * @return \Fastly\Model\SchemasWafFirewallVersion[]|null
     */
     ...
     * Sets included
     *
     * @param \Fastly\Model\SchemasWafFirewallVersion[]|null $included included
     *
     * @return self
     */

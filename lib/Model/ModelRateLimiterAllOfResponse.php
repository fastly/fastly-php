...
/**
 * ModelRateLimiterAllOfResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelRateLimiterAllOfResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_rate_limiter_allOf_response';
    ...
    public function setStatus($status)
    {
        ...
        if (!is_null($status) && ($status > 999)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ModelRateLimiterAllOfResponse., must be smaller than or equal to 999.');
        }
        if (!is_null($status) && ($status < 100)) {
            throw new \InvalidArgumentException('invalid value for $status when calling ModelRateLimiterAllOfResponse., must be bigger than or equal to 100.');
        }
    ...
    public function setContentType($content_type)
    {
        ...
        if (!is_null($content_type) && (mb_strlen($content_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content_type when calling ModelRateLimiterAllOfResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setContent($content)
    {
        ...
        if (!is_null($content) && (mb_strlen($content) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content when calling ModelRateLimiterAllOfResponse., must be bigger than or equal to 1.');
        }

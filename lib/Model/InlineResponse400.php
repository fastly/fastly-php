...
class InlineResponse400 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'inline_response_400';
    ...
    {
        return [
            self::CODE_invalid_grant,
            self::CODE_invalid_request,
            self::CODE_invalid_scope,
            self::CODE_account_locked,
            self::CODE_mfa_verify,
        ];
    }

...
/**
 * LoggingNewrelicotlpAdditional Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class LoggingNewrelicotlpAdditional implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'logging_newrelicotlp_additional';
     ...
     * Sets url
     *
     * @param string|null $url (Optional) URL of the New Relic Trace Observer, if you are using New Relic Infinite Tracing.
     *
     * @return self
     */

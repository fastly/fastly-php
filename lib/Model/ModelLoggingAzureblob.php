...
/**
 * ModelLoggingAzureblob Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelLoggingAzureblob implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_logging_azureblob';
    ...
    protected static $openAPITypes = [
        ...
        'format' => 'string',
        'message_type' => '\OpenAPI\Client\Model\LoggingMessageType',
        'timestamp_format' => 'string',
        'period' => 'int',
        'gzip_level' => 'int',
        'compression_codec' => '\OpenAPI\Client\Model\LoggingCompressionCodec',
        'path' => 'string',
        'account_name' => 'string',
        'container' => 'string',
        'sas_token' => 'string',
     ...
     * Gets message_type
     *
     * @return \OpenAPI\Client\Model\LoggingMessageType|null
     */
     ...
     * Sets message_type
     *
     * @param \OpenAPI\Client\Model\LoggingMessageType|null $message_type message_type
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\LoggingCompressionCodec|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\LoggingCompressionCodec|null $compression_codec compression_codec
     *
     * @return self
     */
    ...
    public function setFileMaxBytes($file_max_bytes)
    {
        ...
        if (!is_null($file_max_bytes) && ($file_max_bytes < 1048576)) {
            throw new \InvalidArgumentException('invalid value for $file_max_bytes when calling ModelLoggingAzureblob., must be bigger than or equal to 1048576.');
        }

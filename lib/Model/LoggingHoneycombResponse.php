...
/**
 * LoggingHoneycombResponse Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class LoggingHoneycombResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'logging_honeycomb_response';
     ...
     * Sets format
     *
     * @param string|null $format A Fastly [log format string](https://www.fastly.com/documentation/guides/integrations/streaming-logs/custom-log-formats/). Must produce valid JSON that Honeycomb can ingest.
     *
     * @return self
     */
     ...
     * Sets token
     *
     * @param string|null $token The Write Key from the Account page of your Honeycomb account.
     *
     * @return self
     */

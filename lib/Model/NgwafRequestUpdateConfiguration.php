...
/**
 * NgwafRequestUpdateConfiguration Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class NgwafRequestUpdateConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'ngwaf_request_update_configuration';
     ...
     * Sets workspace_id
     *
     * @param string|null $workspace_id The workspace to link.
     *
     * @return self
     */

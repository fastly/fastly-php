...
/**
 * ModelRealtimeEntry Class Doc Comment
 *
 * @category Class
 ...
 */
class ModelRealtimeEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_realtime_entry';
     ...
     * Sets aggregated
     *
     * @param object|null $aggregated Aggregates [measurements](#measurements-data-model) across all Fastly data centers.
     *
     * @return self
     */
     ...
     * Sets datacenter
     *
     * @param object|null $datacenter Groups [measurements](#measurements-data-model) by data center. See the [data centers API](/reference/api/utils/datacenter/) for details of data center identifiers.
     *
     * @return self
     */

...
/**
 * WafActiveRuleDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
...
class WafActiveRuleDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'waf_active_rule_data_attributes';
    ...
    protected static $fastlyTypes = [
        'modsec_rule_id' => 'int',
        'revision' => '\Fastly\Model\WafRuleRevisionOrLatest',
        'status' => 'string'
    ];
     ...
     * Gets revision
     *
     * @return \Fastly\Model\WafRuleRevisionOrLatest|null
     */
     ...
     * Sets revision
     *
     * @param \Fastly\Model\WafRuleRevisionOrLatest|null $revision revision
     *
     * @return self
     */

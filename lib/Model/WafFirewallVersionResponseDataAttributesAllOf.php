...
/**
 * WafFirewallVersionResponseDataAttributesAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class WafFirewallVersionResponseDataAttributesAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'waf_firewall_version_response_data_attributes_allOf';

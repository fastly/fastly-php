...
/**
 * ServiceInvitationDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
...
class ServiceInvitationDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'service_invitation_data_attributes';
     ...
     * Sets permission
     *
     * @param string|null $permission The permission the accepting user will have in relation to the service.
     *
     * @return self
     */

...
/**
 * ValuesStatusCodes Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class ValuesStatusCodes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'values-status-codes';
     ...
     * Sets rate_per_url
     *
     * @param float|null $rate_per_url The rate at which the status code in this dimension occurs for this URL.
     *
     * @return self
     */

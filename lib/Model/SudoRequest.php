 ...
 */
class SudoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'sudo_request';
     ...
     * Sets expiry_time
     *
     * @param string|null $expiry_time expiry_time
     *
     * @return self
     */

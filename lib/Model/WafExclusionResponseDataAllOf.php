...
/**
 * WafExclusionResponseDataAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class WafExclusionResponseDataAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'waf_exclusion_response_data_allOf';
     ...
     * Sets id
     *
     * @param string|null $id Alphanumeric string identifying a WAF exclusion.
     *
     * @return self
     */

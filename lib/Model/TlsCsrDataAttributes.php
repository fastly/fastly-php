...
class TlsCsrDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets sans
     *
     * @param string[] $sans Subject Altername Names - An array of one or more fully qualified domain names or public IP addresses to be secured by this certificate. Required.
     *
     * @return self
     */

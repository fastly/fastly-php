...
/**
 * WafRuleRevisionsResponse Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class WafRuleRevisionsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'waf_rule_revisions_response';
     ...
     * Gets included
     *
     * @return \Fastly\Model\WafRule[]|null
     */
     ...
     * Sets included
     *
     * @param \Fastly\Model\WafRule[]|null $included included
     *
     * @return self
     */

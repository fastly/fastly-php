...
class SecretResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'secret_response';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['recreated'] = $data['recreated'] ?? null;
    }
     ...
     * Sets name
     *
     * @param string|null $name Name of the secret.
     *
     * @return self
     */
     ...
     * Sets digest
     *
     * @param string|null $digest An opaque identifier of the plaintext secret value. This can be used to determine if a secret value has changed.
     *
     * @return self
     */

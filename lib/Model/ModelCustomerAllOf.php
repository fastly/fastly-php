...
/**
 * ModelCustomerAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelCustomerAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_customer_allOf';
     ...
     *
     * @param string|null $billing_network_type Customer's current network revenue type. Can be `public` or `private`.
     *
     * @return self
     */

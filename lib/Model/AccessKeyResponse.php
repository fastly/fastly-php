...
class AccessKeyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'access_key_response';
     ...
     * Sets access_key
     *
     * @param string|null $access_key Generated access key.
     *
     * @return self
     */
     ...
     * Sets secret_key
     *
     * @param string|null $secret_key Generated secret key.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description for the access key.
     *
     * @return self
     */
     ...
     * Sets permission
     *
     * @param string|null $permission Permissions granted to an access key.
     *
     * @return self
     */

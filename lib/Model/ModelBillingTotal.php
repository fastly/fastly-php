...
/**
 * ModelBillingTotal Class Doc Comment
 *
 * @category Class
 * @description NESTED
 * @package  OpenAPI\Client
 ...
 */
class ModelBillingTotal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_billing_total';
    ...
    protected static $openAPITypes = [
        ...
        'discount' => 'float',
        'extras' => '\OpenAPI\Client\Model\ModelBillingTotalExtras[]',
        'extras_cost' => 'float',
        'incurred_cost' => 'float',
        'overage' => 'float',
        'plan_code' => 'string',
     ...
     * Gets extras
     *
     * @return \OpenAPI\Client\Model\ModelBillingTotalExtras[]|null
     */
     ...
     * Sets extras
     *
     * @param \OpenAPI\Client\Model\ModelBillingTotalExtras[]|null $extras A list of any extras for this invoice.
     *
     * @return self
     */

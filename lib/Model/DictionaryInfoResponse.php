...
/**
 * DictionaryInfoResponse Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
...
class DictionaryInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'dictionary_info_response';
     ...
     * Sets item_count
     *
     * @param int|null $item_count The number of items currently in the dictionary.
     *
     * @return self
     */

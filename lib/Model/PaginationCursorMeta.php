...
/**
 * PaginationCursorMeta Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class PaginationCursorMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'pagination_cursor_meta';
     ...
     * Sets limit
     *
     * @param int|null $limit Maximum number of results returned.
     *
     * @return self
     */

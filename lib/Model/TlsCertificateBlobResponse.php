...
/**
 * TlsCertificateBlobResponse Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class TlsCertificateBlobResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'tls_certificate_blob_response';
     ...
     * Sets cert_blob
     *
     * @param string|null $cert_blob A certificate blob
     *
     * @return self
     */

...
/**
 * ValuesBrowser Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class ValuesBrowser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'values-browser';
     ...
     * Sets rate
     *
     * @param float|null $rate The percentage of requests by this version of the browser specified in the dimension.
     *
     * @return self
     */

...
/**
 * ModelLoggingKafka Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelLoggingKafka implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_logging_kafka';
    ...
    protected static $openAPITypes = [
        ...
        'user' => 'string',
        'password' => 'string',
        'use_tls' => '\OpenAPI\Client\Model\LoggingUseTls'
    ];
    ...
    const REQUIRED_ACKS_1 = 1;
    const REQUIRED_ACKS_0 = 0;
    const REQUIRED_ACKS_MINUS_1 = -1;
    ...
    {
        return [
            self::REQUIRED_ACKS_1,
            self::REQUIRED_ACKS_0,
            self::REQUIRED_ACKS_MINUS_1,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['required_acks'] = $data['required_acks'] ?? REQUIRED_ACKS_1;
     ...
     * Gets use_tls
     *
     * @return \OpenAPI\Client\Model\LoggingUseTls|null
     */
     ...
     * Sets use_tls
     *
     * @param \OpenAPI\Client\Model\LoggingUseTls|null $use_tls use_tls
     *
     * @return self
     */

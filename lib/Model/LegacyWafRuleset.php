...
/**
 * LegacyWafRuleset Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class LegacyWafRuleset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'legacy_waf_ruleset';
     ...
     * Sets last_push
     *
     * @param string|null $last_push Date and time WAF ruleset VCL was last deployed.
     *
     * @return self
     */
     ...
     * Sets vcl
     *
     * @param string|null $vcl The WAF ruleset VCL currently deployed.
     *
     * @return self
     */

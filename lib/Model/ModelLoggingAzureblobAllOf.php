...
/**
 * ModelLoggingAzureblobAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ModelLoggingAzureblobAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'model_logging_azureblob_allOf';
    ...
    public function setFileMaxBytes($file_max_bytes)
    {
        ...
        if (!is_null($file_max_bytes) && ($file_max_bytes < 1048576)) {
            throw new \InvalidArgumentException('invalid value for $file_max_bytes when calling ModelLoggingAzureblobAllOf., must be bigger than or equal to 1048576.');
        }

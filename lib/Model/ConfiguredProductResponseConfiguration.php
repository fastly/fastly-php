...
/**
 * ConfiguredProductResponseConfiguration Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class ConfiguredProductResponseConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'configured_product_response_configuration';
     ...
     * Sets traffic_ramp
     *
     * @param string|null $traffic_ramp Traffic ramp
     *
     * @return self
     */

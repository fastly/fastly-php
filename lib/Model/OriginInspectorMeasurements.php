...
/**
 * OriginInspectorMeasurements Class Doc Comment
 *
 * @category Class
 ...
 */
class OriginInspectorMeasurements implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'origin_inspector_measurements';

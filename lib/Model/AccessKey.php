...
class AccessKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'access_key';
     ...
     * Sets description
     *
     * @param string $description A description of the access key.
     *
     * @return self
     */
     ...
     * Sets permission
     *
     * @param string $permission The permissions granted to an access key.
     *
     * @return self
     */

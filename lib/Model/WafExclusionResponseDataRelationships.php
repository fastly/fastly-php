...
/**
 * WafExclusionResponseDataRelationships Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class WafExclusionResponseDataRelationships implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'waf_exclusion_response_data_relationships';
    ...
    protected static $fastlyTypes = [
        'waf_rules' => '\Fastly\Model\RelationshipWafRuleWafRule',
    ...
    {
        $this->container['waf_rules'] = $data['waf_rules'] ?? null;
     ...
     * Gets waf_rules
     *
     * @return \Fastly\Model\RelationshipWafRuleWafRule|null
     */
    public function getWafRules()
    {
        return $this->container['waf_rules'];
    }

    /**
     * Sets waf_rules
     *
     * @param \Fastly\Model\RelationshipWafRuleWafRule|null $waf_rules waf_rules
     *
     * @return self
     */
    public function setWafRules($waf_rules)
    {
        $this->container['waf_rules'] = $waf_rules;

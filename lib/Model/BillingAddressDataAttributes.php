...
/**
 * BillingAddressDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class BillingAddressDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'billing_address_data_attributes';
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling BillingAddressDataAttributes., must be smaller than or equal to 2.');
        }
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling BillingAddressDataAttributes., must be bigger than or equal to 2.');
        }
        if (!is_null($country) && (!preg_match("/^[A-Z]{2}$/", $country))) {
            throw new \InvalidArgumentException("invalid value for $country when calling BillingAddressDataAttributes., must conform to the pattern /^[A-Z]{2}$/.");
        }

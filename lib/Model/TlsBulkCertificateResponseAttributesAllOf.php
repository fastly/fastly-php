...
/**
 * TlsBulkCertificateResponseAttributesAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class TlsBulkCertificateResponseAttributesAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'tls_bulk_certificate_response_attributes_allOf';

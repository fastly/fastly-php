...
/**
 * RelationshipsForTlsActivation Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class RelationshipsForTlsActivation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'relationships_for_tls_activation';
     ...
     *
     * @param \Fastly\Model\RelationshipTlsCertificateTlsCertificate|null $tls_certificate tls_certificate
     *
     * @return self
     */

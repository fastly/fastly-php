...
/**
 * BulkUpdateConfigStoreItemAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class BulkUpdateConfigStoreItemAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'bulk_update_config_store_item_allOf';

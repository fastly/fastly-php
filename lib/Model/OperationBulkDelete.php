...
/**
 * OperationBulkDelete Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class OperationBulkDelete implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'operationBulkDelete';
     ...
     * Sets operation_ids
     *
     * @param string[] $operation_ids List of operation IDs to delete.
     *
     * @return self
     */

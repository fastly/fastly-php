...
/**
 * TlsBulkCertificateResponseDataAllOf Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class TlsBulkCertificateResponseDataAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'tls_bulk_certificate_response_data_allOf';

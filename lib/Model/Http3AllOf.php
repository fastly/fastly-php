 ...
 */
class Http3AllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'http3_allOf';
    ...
    public function setFeatureRevision($feature_revision)
    {
        ...
        if (!is_null($feature_revision) && ($feature_revision < 1)) {
            throw new \InvalidArgumentException('invalid value for $feature_revision when calling Http3AllOf., must be bigger than or equal to 1.');
        }

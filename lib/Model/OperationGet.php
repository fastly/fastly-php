...
/**
 * OperationGet Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class OperationGet implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'operationGet';
     ...
     * Sets id
     *
     * @param string $id The unique identifier of the operation.
     *
     * @return self
     */
     ...
     * Sets updated_at
     *
     * @param \DateTime $updated_at The timestamp when the operation was last updated.
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 140)) {
            throw new \InvalidArgumentException('invalid length for $description when calling OperationGet., must be smaller than or equal to 140.');
        }
     ...
     * Sets tag_ids
     *
     * @param string[]|null $tag_ids An array of operation tag IDs associated with this operation.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param \DateTime|null $created_at The timestamp when the operation was created.
     *
     * @return self
     */

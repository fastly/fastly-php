...
/**
 * SchemasWafFirewallVersionDataAttributes Class Doc Comment
 *
 * @category Class
 * @package  Fastly
 * @author   oss@fastly.com
 ...
 */
class SchemasWafFirewallVersionDataAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $fastlyModelName = 'schemas_waf_firewall_version_data_attributes';
     ...
     * Sets arg_length
     *
     * @param int|null $arg_length The maximum number of arguments allowed.
     *
     * @return self
     */

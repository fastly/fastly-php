...
class HealthcheckApi
{
     ...
     * @return \OpenAPI\Client\Model\ModelHealthcheck
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ModelHealthcheck, HTTP status code, HTTP response headers (array of strings)
     */
    public function createHealthcheckWithHttpInfo($service_id, $version_id, $service_id2 = null, $version = null, $check_interval = null, $comment = '', $expected_response = null, $host = null, $http_version = null, $initial = null, $method = null, $name = null, $path = null, $threshold = null, $timeout = null, $window = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ModelHealthcheck' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ModelHealthcheck', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ModelHealthcheck';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ModelHealthcheck',

...
class DirectorApi
{
     ...
     * @param  \OpenAPI\Client\Model\SchemasModelBackend[] $backends List of backends associated to a director. (optional)
     ...
     * @return \OpenAPI\Client\Model\ModelDirector
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ModelDirector, HTTP status code, HTTP response headers (array of strings)
     */
    public function createDirectorWithHttpInfo($service_id, $version_id, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $backends = null, $capacity = null, $comment = '', $name = null, $quorum = 75, $shield = 'null', $type = 1, $retries = 5)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ModelDirector' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ModelDirector', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ModelDirector';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ModelDirector',

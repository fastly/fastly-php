...
class IamRolesApi
{
     ...
     * @return object
     */
    public function addRolePermissions($options)
    {
        list($response) = $this->addRolePermissionsWithHttpInfo($options);
        return $response;
    }

    /**
     * Operation addRolePermissionsWithHttpInfo
     *
     * Add permissions to a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     */
    public function addRolePermissionsWithHttpInfo($options)
    {
        $request = $this->addRolePermissionsRequest($options);
    ...
    /**
     * Operation addRolePermissionsAsync
     *
     * Add permissions to a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     */
    public function addRolePermissionsAsync($options)
    {
        return $this->addRolePermissionsAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addRolePermissionsAsyncWithHttpInfo
     *
     * Add permissions to a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addRolePermissionsAsyncWithHttpInfo($options)
    {
        $returnType = 'object';
        $request = $this->addRolePermissionsRequest($options);
    ...
    /**
     * Create request for operation 'addRolePermissions'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     */
    public function addRolePermissionsRequest($options)
    {
        ...
        if ($role_id === null || (is_array($role_id) && count($role_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $role_id when calling addRolePermissions'
            );
        }
     ...
     * @return object
     */
    public function createARole($options)
    {
    ...
    /**
     * Operation createARoleWithHttpInfo
     *
     * Create a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
    ...
    {
        $request = $this->createARoleRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createARoleAsync($options)
    {
    ...
    /**
     * Operation createARoleAsyncWithHttpInfo
     *
     * Create a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
    ...
    /**
     * Create request for operation 'createARole'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createARoleRequest($options)
    {
        // unbox the parameters from the associative array
        $request_body = array_key_exists('request_body', $options) ? $options['request_body'] : null;
    ...
    /**
     * Operation removeRolePermissions
     *
     ...
     * @return void
     */
    public function removeRolePermissions($options)
    {
        $this->removeRolePermissionsWithHttpInfo($options);
    }

    /**
     * Operation removeRolePermissionsWithHttpInfo
     *
     * Remove permissions from a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeRolePermissionsWithHttpInfo($options)
    {
        $request = $this->removeRolePermissionsRequest($options);
    ...
    /**
     * Operation removeRolePermissionsAsync
     *
     * Remove permissions from a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeRolePermissionsAsync($options)
    {
        return $this->removeRolePermissionsAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation removeRolePermissionsAsyncWithHttpInfo
     *
     * Remove permissions from a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeRolePermissionsAsyncWithHttpInfo($options)
    {
        $returnType = '';
        $request = $this->removeRolePermissionsRequest($options);
    ...
    /**
     * Create request for operation 'removeRolePermissions'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeRolePermissionsRequest($options)
    {
        // unbox the parameters from the associative array
        $role_id = array_key_exists('role_id', $options) ? $options['role_id'] : null;
        $request_body = array_key_exists('request_body', $options) ? $options['request_body'] : null;
        ...
        if ($role_id === null || (is_array($role_id) && count($role_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $role_id when calling removeRolePermissions'
            );
        }
     ...
     * @return object
     */
    public function updateARole($options)
    {
        list($response) = $this->updateARoleWithHttpInfo($options);
        return $response;
    }

    /**
     * Operation updateARoleWithHttpInfo
     *
     * Update a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateARoleWithHttpInfo($options)
    {
        $request = $this->updateARoleRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateARoleAsync($options)
    {
        return $this->updateARoleAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateARoleAsyncWithHttpInfo
     *
     * Update a role
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateARoleAsyncWithHttpInfo($options)
    {
        $returnType = 'object';
        $request = $this->updateARoleRequest($options);
    ...
    /**
     * Create request for operation 'updateARole'
     *
     * Note: the input parameter is an associative array with the keys listed as the parameter name below
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateARoleRequest($options)
    {
        // unbox the parameters from the associative array
        $role_id = array_key_exists('role_id', $options) ? $options['role_id'] : null;
        $request_body = array_key_exists('request_body', $options) ? $options['request_body'] : null;
        ...
        if ($role_id === null || (is_array($role_id) && count($role_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $role_id when calling updateARole'
            );
        }

...
class CacheSettingsApi
{
     ...
     * @return \OpenAPI\Client\Model\ModelCacheSettings
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ModelCacheSettings, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCacheSettingsWithHttpInfo($service_id, $version_id, $service_id2 = null, $version = null, $action = null, $cache_condition = null, $name = null, $stale_ttl = null, $ttl = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ModelCacheSettings' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ModelCacheSettings', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ModelCacheSettings';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ModelCacheSettings',

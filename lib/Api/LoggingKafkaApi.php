...
class LoggingKafkaApi
{
     ...
     * @return \Fastly\Model\LoggingKafkaResponsePost
     */
    public function createLogKafka($options)
    {
        list($response) = $this->createLogKafkaWithHttpInfo($options);
        return $response;
    }
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Fastly\Model\LoggingKafkaResponsePost, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLogKafkaWithHttpInfo($options)
    {
        $request = $this->createLogKafkaRequest($options);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Fastly\Model\LoggingKafkaResponsePost' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Fastly\Model\LoggingKafkaResponsePost', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Fastly\Model\LoggingKafkaResponsePost';
     ...
     */
    public function createLogKafkaAsync($options)
    {
        return $this->createLogKafkaAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createLogKafkaAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\LoggingKafkaResponsePost';
        $request = $this->createLogKafkaRequest($options);
     ...
     */
    public function createLogKafkaRequest($options)
    {
     ...
     */
    public function deleteLogKafka($options)
    {
        list($response) = $this->deleteLogKafkaWithHttpInfo($options);
        return $response;
    }
     ...
     */
    public function deleteLogKafkaWithHttpInfo($options)
    {
        $request = $this->deleteLogKafkaRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLogKafkaAsync($options)
    {
        return $this->deleteLogKafkaAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLogKafkaAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\InlineResponse200';
        $request = $this->deleteLogKafkaRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteLogKafkaRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;
     ...
     */
    public function getLogKafka($options)
    {
        list($response) = $this->getLogKafkaWithHttpInfo($options);
        return $response;
    }
     ...
     */
    public function getLogKafkaWithHttpInfo($options)
    {
        $request = $this->getLogKafkaRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLogKafkaAsync($options)
    {
        return $this->getLogKafkaAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLogKafkaAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\LoggingKafkaResponse';
        $request = $this->getLogKafkaRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getLogKafkaRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;
     ...
     * @return \Fastly\Model\LoggingKafkaResponse[]
     */
    public function listLogKafka($options)
    {
        list($response) = $this->listLogKafkaWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\LoggingKafkaResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listLogKafkaWithHttpInfo($options)
    {
        $request = $this->listLogKafkaRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLogKafkaAsync($options)
    {
        return $this->listLogKafkaAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLogKafkaAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\LoggingKafkaResponse[]';
        $request = $this->listLogKafkaRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listLogKafkaRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;

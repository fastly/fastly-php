...
class TokensApi
{
     ...
     * @return \Fastly\Model\TokenResponse|\Fastly\Model\GenericTokenError|\Fastly\Model\GenericTokenError|\Fastly\Model\GenericTokenError
     */
    public function getToken($options)
    {
        list($response) = $this->getTokenWithHttpInfo($options);
        return $response;
    }
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Fastly\Model\TokenResponse|\Fastly\Model\GenericTokenError|\Fastly\Model\GenericTokenError|\Fastly\Model\GenericTokenError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTokenWithHttpInfo($options)
    {
        $request = $this->getTokenRequest($options);
     ...
     */
    public function getTokenAsync($options)
    {
        return $this->getTokenAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTokenAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\TokenResponse';
        $request = $this->getTokenRequest($options);
     ...
     */
    public function getTokenRequest($options)
    {

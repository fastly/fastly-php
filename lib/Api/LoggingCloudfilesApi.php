...
class LoggingCloudfilesApi
{
     ...
     * @return \OpenAPI\Client\Model\ModelLoggingCloudfiles
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ModelLoggingCloudfiles, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLogCloudfilesWithHttpInfo($service_id, $version_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ModelLoggingCloudfiles' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ModelLoggingCloudfiles', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ModelLoggingCloudfiles';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ModelLoggingCloudfiles',
     ...
     * @return \OpenAPI\Client\Model\ModelLoggingCloudfiles
     */
    public function updateLogCloudfiles($service_id, $version_id, $logging_cloudfiles_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = null, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = null, $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $access_key = null, $bucket_name = null, $path = 'null', $region = null, $public_key = 'null', $user = null)
    {
     ...
     * @return array of \OpenAPI\Client\Model\ModelLoggingCloudfiles, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateLogCloudfilesWithHttpInfo($service_id, $version_id, $logging_cloudfiles_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = null, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = null, $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $access_key = null, $bucket_name = null, $path = 'null', $region = null, $public_key = 'null', $user = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLogCloudfilesAsync($service_id, $version_id, $logging_cloudfiles_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = null, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = null, $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $access_key = null, $bucket_name = null, $path = 'null', $region = null, $public_key = 'null', $user = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLogCloudfilesAsyncWithHttpInfo($service_id, $version_id, $logging_cloudfiles_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = null, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = null, $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $access_key = null, $bucket_name = null, $path = 'null', $region = null, $public_key = 'null', $user = null)
    {
        $returnType = '\OpenAPI\Client\Model\ModelLoggingCloudfiles';
        $request = $this->updateLogCloudfilesRequest($service_id, $version_id, $logging_cloudfiles_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $timestamp_format, $period, $gzip_level, $compression_codec, $access_key, $bucket_name, $path, $region, $public_key, $user);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateLogCloudfilesRequest($service_id, $version_id, $logging_cloudfiles_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = null, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $message_type = null, $timestamp_format = null, $period = 3600, $gzip_level = 0, $compression_codec = null, $access_key = null, $bucket_name = null, $path = 'null', $region = null, $public_key = 'null', $user = null)
    {
        // verify the required parameter 'service_id' is set
        if ($service_id === null || (is_array($service_id) && count($service_id) === 0)) {
            throw new \InvalidArgumentException(

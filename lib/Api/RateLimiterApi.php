...
class RateLimiterApi
{
     ...
     * @param  string[] $client_key Array of VCL variables used to generate a counter key to identify a client. Examples variables include &#x60;req.http.Fastly-Client-IP&#x60;, &#x60;req.http.User-Agent&#x60;, or a custom header like &#x60;req.http.API-Key&#x60;. (optional)
     ...
     * @param  string $action The action to take when a rate limiter violation is detected. \\\&quot;response\\\&quot; and \\\&quot;response_object\\\&quot; prevent an origin request; \\\&quot;log_only\\\&quot; logs the violation but allows the origin request to continue. (optional)
     * @param  \OpenAPI\Client\Model\ModelRateLimiterAllOfResponse $response response (optional)
     ...
     * @return \OpenAPI\Client\Model\ModelRateLimiter[]
     */
    public function createRateLimiter($service_id, $version_id, $service_id2 = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        list($response) = $this->createRateLimiterWithHttpInfo($service_id, $version_id, $service_id2, $version, $created_at, $deleted_at, $updated_at, $name, $uri_dictionary_name, $http_methods, $rps_limit, $window_size, $client_key, $penalty_box_duration, $action, $response, $response_object_name, $logger_type, $feature_revision);
        return $response;
    }
     ...
     * @param  int $penalty_box_duration Length of time in seconds that the rate limiter is in effect after the initial violation is detected. (optional)
     * @param  string $action The action to take when a rate limiter violation is detected. \\\&quot;response\\\&quot; and \\\&quot;response_object\\\&quot; prevent an origin request; \\\&quot;log_only\\\&quot; logs the violation but allows the origin request to continue. (optional)
     * @param  \OpenAPI\Client\Model\ModelRateLimiterAllOfResponse $response (optional)
     * @param  string $response_object_name Name of existing response object. Required if &#x60;action&#x60; is \\\&quot;response_object\\\&quot;. Note that the rate limiter response is only updated to reflect the response object content when saving the rate limiter configuration. (optional)
     * @param  string $logger_type Name of the type of logging endpoint to be used when action is \\\&quot;log_only\\\&quot;. The logging endpoint type is used to determine the appropriate log format to use when emitting log entries. (optional)
     * @param  int $feature_revision Revision number of the rate limiting feature implementation. Defaults to the most recent revision. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ModelRateLimiter[], HTTP status code, HTTP response headers (array of strings)
     */
    public function createRateLimiterWithHttpInfo($service_id, $version_id, $service_id2 = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        $request = $this->createRateLimiterRequest($service_id, $version_id, $service_id2, $version, $created_at, $deleted_at, $updated_at, $name, $uri_dictionary_name, $http_methods, $rps_limit, $window_size, $client_key, $penalty_box_duration, $action, $response, $response_object_name, $logger_type, $feature_revision);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ModelRateLimiter[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ModelRateLimiter[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\ModelRateLimiter[]';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ModelRateLimiter[]',
     ...
     */
    public function createRateLimiterAsync($service_id, $version_id, $service_id2 = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        return $this->createRateLimiterAsyncWithHttpInfo($service_id, $version_id, $service_id2, $version, $created_at, $deleted_at, $updated_at, $name, $uri_dictionary_name, $http_methods, $rps_limit, $window_size, $client_key, $penalty_box_duration, $action, $response, $response_object_name, $logger_type, $feature_revision)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRateLimiterAsyncWithHttpInfo($service_id, $version_id, $service_id2 = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        $returnType = '\OpenAPI\Client\Model\ModelRateLimiter[]';
        $request = $this->createRateLimiterRequest($service_id, $version_id, $service_id2, $version, $created_at, $deleted_at, $updated_at, $name, $uri_dictionary_name, $http_methods, $rps_limit, $window_size, $client_key, $penalty_box_duration, $action, $response, $response_object_name, $logger_type, $feature_revision);
     ...
     */
    public function createRateLimiterRequest($service_id, $version_id, $service_id2 = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        ...
        if ($feature_revision !== null && strlen($feature_revision) < 1) {
            throw new \InvalidArgumentException('invalid length for "$feature_revision" when calling RateLimiterApi.createRateLimiter, must be bigger than or equal to 1.');
        }
     ...
     * @return \OpenAPI\Client\Model\ModelRateLimiter[]
     */
    public function updateRateLimiter($rate_limiter_id, $service_id = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        list($response) = $this->updateRateLimiterWithHttpInfo($rate_limiter_id, $service_id, $version, $created_at, $deleted_at, $updated_at, $name, $uri_dictionary_name, $http_methods, $rps_limit, $window_size, $client_key, $penalty_box_duration, $action, $response, $response_object_name, $logger_type, $feature_revision);
        return $response;
    }
    ...
    {
        $request = $this->updateRateLimiterRequest($rate_limiter_id, $service_id, $version, $created_at, $deleted_at, $updated_at, $name, $uri_dictionary_name, $http_methods, $rps_limit, $window_size, $client_key, $penalty_box_duration, $action, $response, $response_object_name, $logger_type, $feature_revision);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRateLimiterAsync($rate_limiter_id, $service_id = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        return $this->updateRateLimiterAsyncWithHttpInfo($rate_limiter_id, $service_id, $version, $created_at, $deleted_at, $updated_at, $name, $uri_dictionary_name, $http_methods, $rps_limit, $window_size, $client_key, $penalty_box_duration, $action, $response, $response_object_name, $logger_type, $feature_revision)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRateLimiterAsyncWithHttpInfo($rate_limiter_id, $service_id = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        $returnType = '\OpenAPI\Client\Model\ModelRateLimiter[]';
        $request = $this->updateRateLimiterRequest($rate_limiter_id, $service_id, $version, $created_at, $deleted_at, $updated_at, $name, $uri_dictionary_name, $http_methods, $rps_limit, $window_size, $client_key, $penalty_box_duration, $action, $response, $response_object_name, $logger_type, $feature_revision);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRateLimiterRequest($rate_limiter_id, $service_id = null, $version = null, $created_at = null, $deleted_at = null, $updated_at = null, $name = null, $uri_dictionary_name = null, $http_methods = null, $rps_limit = null, $window_size = null, $client_key = null, $penalty_box_duration = null, $action = null, $response = null, $response_object_name = null, $logger_type = null, $feature_revision = null)
    {
        // verify the required parameter 'rate_limiter_id' is set
        if ($rate_limiter_id === null || (is_array($rate_limiter_id) && count($rate_limiter_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($feature_revision !== null && strlen($feature_revision) < 1) {
            throw new \InvalidArgumentException('invalid length for "$feature_revision" when calling RateLimiterApi.updateRateLimiter, must be bigger than or equal to 1.');
        }

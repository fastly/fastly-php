...
class LoggingSumologicApi
{
     ...
     * @return \Fastly\Model\LoggingSumologicResponse
     */
    public function createLogSumologic($options)
    {
        list($response) = $this->createLogSumologicWithHttpInfo($options);
        return $response;
    }
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Fastly\Model\LoggingSumologicResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createLogSumologicWithHttpInfo($options)
    {
        $request = $this->createLogSumologicRequest($options);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Fastly\Model\LoggingSumologicResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Fastly\Model\LoggingSumologicResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Fastly\Model\LoggingSumologicResponse';
     ...
     */
    public function createLogSumologicAsync($options)
    {
        return $this->createLogSumologicAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createLogSumologicAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\LoggingSumologicResponse';
        $request = $this->createLogSumologicRequest($options);
     ...
     */
    public function createLogSumologicRequest($options)
    {
     ...
     */
    public function deleteLogSumologic($options)
    {
        list($response) = $this->deleteLogSumologicWithHttpInfo($options);
        return $response;
    }
     ...
     */
    public function deleteLogSumologicWithHttpInfo($options)
    {
        $request = $this->deleteLogSumologicRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLogSumologicAsync($options)
    {
        return $this->deleteLogSumologicAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteLogSumologicAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\InlineResponse200';
        $request = $this->deleteLogSumologicRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteLogSumologicRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;
        $logging_sumologic_name = array_key_exists('logging_sumologic_name', $options) ? $options['logging_sumologic_name'] : null;
     ...
     * @return \Fastly\Model\LoggingSumologicResponse
     */
    public function getLogSumologic($options)
    {
        list($response) = $this->getLogSumologicWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\LoggingSumologicResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLogSumologicWithHttpInfo($options)
    {
        $request = $this->getLogSumologicRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLogSumologicAsync($options)
    {
        return $this->getLogSumologicAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLogSumologicAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\LoggingSumologicResponse';
        $request = $this->getLogSumologicRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getLogSumologicRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;
     ...
     * @return \Fastly\Model\LoggingSumologicResponse[]
     */
    public function listLogSumologic($options)
    {
        list($response) = $this->listLogSumologicWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\LoggingSumologicResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listLogSumologicWithHttpInfo($options)
    {
        $request = $this->listLogSumologicRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLogSumologicAsync($options)
    {
        return $this->listLogSumologicAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listLogSumologicAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\LoggingSumologicResponse[]';
        $request = $this->listLogSumologicRequest($options);
     ...
     * @return \Fastly\Model\LoggingSumologicResponse
     */
    public function updateLogSumologic($options)
    {
        list($response) = $this->updateLogSumologicWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\LoggingSumologicResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateLogSumologicWithHttpInfo($options)
    {
        $request = $this->updateLogSumologicRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLogSumologicAsync($options)
    {
        return $this->updateLogSumologicAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateLogSumologicAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\LoggingSumologicResponse';
        $request = $this->updateLogSumologicRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateLogSumologicRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;

...
class TlsDomainsApi
{
     ...
     * @param  string $include Include related objects. Optional, comma-separated values. Permitted values: &#x60;tls_activations&#x60;, &#x60;tls_certificates&#x60;, &#x60;tls_subscriptions&#x60;, and &#x60;tls_subscriptions.tls_authorizations&#x60;. (optional)
    ...
    public function listTlsDomainsRequest($options)
    {
        ...
        if ($filter_tls_certificates_id !== null) {
            if('form' === 'form' && is_array($filter_tls_certificates_id)) {
                ...
                $queryParams['filter[tls_certificates.id]'] = $filter_tls_certificates_id;
            }
        }
        // query params
        if ($filter_tls_subscriptions_id !== null) {
            if('form' === 'form' && is_array($filter_tls_subscriptions_id)) {
                ...
                $queryParams['filter[tls_subscriptions.id]'] = $filter_tls_subscriptions_id;
            }
        }
        // query params
        if ($include !== null) {

...
class RealtimeApi
{
     ...
     * @return \Fastly\Model\Realtime
     */
    public function getStatsLast120Seconds($options)
    {
        list($response) = $this->getStatsLast120SecondsWithHttpInfo($options);
        return $response;
    }
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Fastly\Model\Realtime, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatsLast120SecondsWithHttpInfo($options)
    {
        $request = $this->getStatsLast120SecondsRequest($options);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Fastly\Model\Realtime' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Fastly\Model\Realtime', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Fastly\Model\Realtime';
     ...
     */
    public function getStatsLast120SecondsAsync($options)
    {
        return $this->getStatsLast120SecondsAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatsLast120SecondsAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\Realtime';
        $request = $this->getStatsLast120SecondsRequest($options);
     ...
     */
    public function getStatsLast120SecondsRequest($options)
    {
     ...
     * @return \Fastly\Model\Realtime
     */
    public function getStatsLast120SecondsLimitEntries($options)
    {
        list($response) = $this->getStatsLast120SecondsLimitEntriesWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\Realtime, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatsLast120SecondsLimitEntriesWithHttpInfo($options)
    {
        $request = $this->getStatsLast120SecondsLimitEntriesRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatsLast120SecondsLimitEntriesAsync($options)
    {
        return $this->getStatsLast120SecondsLimitEntriesAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatsLast120SecondsLimitEntriesAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\Realtime';
        $request = $this->getStatsLast120SecondsLimitEntriesRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getStatsLast120SecondsLimitEntriesRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $max_entries = array_key_exists('max_entries', $options) ? $options['max_entries'] : null;
     ...
     * @return \Fastly\Model\Realtime
     */
    public function getStatsLastSecond($options)
    {
        list($response) = $this->getStatsLastSecondWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\Realtime, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatsLastSecondWithHttpInfo($options)
    {
        $request = $this->getStatsLastSecondRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatsLastSecondAsync($options)
    {
        return $this->getStatsLastSecondAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatsLastSecondAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\Realtime';
        $request = $this->getStatsLastSecondRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getStatsLastSecondRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $timestamp_in_seconds = array_key_exists('timestamp_in_seconds', $options) ? $options['timestamp_in_seconds'] : null;

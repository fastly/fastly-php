...
class ServiceApi
{
     ...
     * @return \Fastly\Model\ServiceResponse
     */
    public function createService($options)
    {
        list($response) = $this->createServiceWithHttpInfo($options);
        return $response;
    }
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Fastly\Model\ServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createServiceWithHttpInfo($options)
    {
        $request = $this->createServiceRequest($options);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Fastly\Model\ServiceResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Fastly\Model\ServiceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Fastly\Model\ServiceResponse';
     ...
     */
    public function createServiceAsync($options)
    {
        return $this->createServiceAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createServiceAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\ServiceResponse';
        $request = $this->createServiceRequest($options);
     ...
     */
    public function createServiceRequest($options)
    {
    ...
    {
        list($response) = $this->deleteServiceWithHttpInfo($options);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteServiceAsync($options)
    {
        return $this->deleteServiceAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteServiceRequest($options)
    {
        // unbox the parameters from the associative array
    ...
    {
        list($response) = $this->getServiceWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\ServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServiceWithHttpInfo($options)
    {
        $request = $this->getServiceRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServiceAsync($options)
    {
        return $this->getServiceAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServiceAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\ServiceResponse';
        $request = $this->getServiceRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getServiceRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Fastly\Model\ServiceDetail
     */
    public function getServiceDetail($options)
    {
        list($response) = $this->getServiceDetailWithHttpInfo($options);
        return $response;
    }
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Fastly\Model\ServiceDetail, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServiceDetailWithHttpInfo($options)
    {
        $request = $this->getServiceDetailRequest($options);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Fastly\Model\ServiceDetail' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Fastly\Model\ServiceDetail', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Fastly\Model\ServiceDetail';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServiceDetailAsync($options)
    {
        return $this->getServiceDetailAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getServiceDetailAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\ServiceDetail';
        $request = $this->getServiceDetailRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getServiceDetailRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
    ...
    {
        list($response) = $this->listServiceDomainsWithHttpInfo($options);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listServiceDomainsAsync($options)
    {
        return $this->listServiceDomainsAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listServiceDomainsRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Fastly\Model\ServiceListResponse[]
     */
    public function listServices($options)
    {
        list($response) = $this->listServicesWithHttpInfo($options);
        return $response;
    }
     ...
     * @throws \Fastly\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Fastly\Model\ServiceListResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listServicesWithHttpInfo($options)
    {
        $request = $this->listServicesRequest($options);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Fastly\Model\ServiceListResponse[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Fastly\Model\ServiceListResponse[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Fastly\Model\ServiceListResponse[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listServicesAsync($options)
    {
        return $this->listServicesAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listServicesAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\ServiceListResponse[]';
        $request = $this->listServicesRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listServicesRequest($options)
    {
        // unbox the parameters from the associative array
        ...
        if ($per_page !== null && $per_page > 100) {
            throw new \InvalidArgumentException('invalid value for "$per_page" when calling ServiceApi.listServices, must be smaller than or equal to 100.');
        }
     ...
     * @return \Fastly\Model\ServiceResponse
     */
    public function searchService($options)
    {
        list($response) = $this->searchServiceWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\ServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchServiceWithHttpInfo($options)
    {
        $request = $this->searchServiceRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchServiceAsync($options)
    {
        return $this->searchServiceAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchServiceAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\ServiceResponse';
        $request = $this->searchServiceRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchServiceRequest($options)
    {
        // unbox the parameters from the associative array
        $name = array_key_exists('name', $options) ? $options['name'] : null;
    ...
    {
        list($response) = $this->updateServiceWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\ServiceResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateServiceWithHttpInfo($options)
    {
        $request = $this->updateServiceRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateServiceAsync($options)
    {
        return $this->updateServiceAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateServiceAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\ServiceResponse';
        $request = $this->updateServiceRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateServiceRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $comment = array_key_exists('comment', $options) ? $options['comment'] : null;

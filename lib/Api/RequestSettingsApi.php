...
class RequestSettingsApi
{
    ...
    {
        list($response) = $this->deleteRequestSettingsWithHttpInfo($options);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteRequestSettingsAsync($options)
    {
        return $this->deleteRequestSettingsAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteRequestSettingsRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;
     ...
     * @return \Fastly\Model\RequestSettingsResponse
     */
    public function getRequestSettings($options)
    {
        list($response) = $this->getRequestSettingsWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\RequestSettingsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRequestSettingsWithHttpInfo($options)
    {
        $request = $this->getRequestSettingsRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRequestSettingsAsync($options)
    {
        return $this->getRequestSettingsAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRequestSettingsAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\RequestSettingsResponse';
        $request = $this->getRequestSettingsRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRequestSettingsRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;
     ...
     * @return \Fastly\Model\RequestSettingsResponse[]
     */
    public function listRequestSettings($options)
    {
        list($response) = $this->listRequestSettingsWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\RequestSettingsResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function listRequestSettingsWithHttpInfo($options)
    {
        $request = $this->listRequestSettingsRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listRequestSettingsAsync($options)
    {
        return $this->listRequestSettingsAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listRequestSettingsAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\RequestSettingsResponse[]';
        $request = $this->listRequestSettingsRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listRequestSettingsRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;
     ...
     * @return \Fastly\Model\RequestSettingsResponse
     */
    public function updateRequestSettings($options)
    {
        list($response) = $this->updateRequestSettingsWithHttpInfo($options);
        return $response;
    }
     ...
     * @return array of \Fastly\Model\RequestSettingsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateRequestSettingsWithHttpInfo($options)
    {
        $request = $this->updateRequestSettingsRequest($options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRequestSettingsAsync($options)
    {
        return $this->updateRequestSettingsAsyncWithHttpInfo($options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateRequestSettingsAsyncWithHttpInfo($options)
    {
        $returnType = '\Fastly\Model\RequestSettingsResponse';
        $request = $this->updateRequestSettingsRequest($options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateRequestSettingsRequest($options)
    {
        // unbox the parameters from the associative array
        $service_id = array_key_exists('service_id', $options) ? $options['service_id'] : null;
        $version_id = array_key_exists('version_id', $options) ? $options['version_id'] : null;
        ...
        // form params
        if ($force_miss !== null) {
            $formParams['force_miss'] = ObjectSerializer::toFormValue($force_miss);
        }
        // form params
        if ($force_ssl !== null) {
            $formParams['force_ssl'] = ObjectSerializer::toFormValue($force_ssl);
        }
        // form params
        if ($geo_headers !== null) {

...
class InlineObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setHttpMethods($http_methods)
    {
        ...
        if ((count($http_methods) < 1)) {
            throw new \InvalidArgumentException('invalid length for $http_methods when calling InlineObject., number of items must be greater than or equal to 1.');
        }
    ...
    public function setRpsLimit($rps_limit)
    {
        ...
        if (($rps_limit > 10000)) {
            throw new \InvalidArgumentException('invalid value for $rps_limit when calling InlineObject., must be smaller than or equal to 10000.');
        }
        if (($rps_limit < 10)) {
            throw new \InvalidArgumentException('invalid value for $rps_limit when calling InlineObject., must be bigger than or equal to 10.');
        }
    ...
    public function setClientKey($client_key)
    {
        ...
        if ((count($client_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $client_key when calling InlineObject., number of items must be greater than or equal to 1.');
        }
    ...
    public function setPenaltyBoxDuration($penalty_box_duration)
    {
        ...
        if (($penalty_box_duration > 60)) {
            throw new \InvalidArgumentException('invalid value for $penalty_box_duration when calling InlineObject., must be smaller than or equal to 60.');
        }
        if (($penalty_box_duration < 1)) {
            throw new \InvalidArgumentException('invalid value for $penalty_box_duration when calling InlineObject., must be bigger than or equal to 1.');
        }
    ...
    public function setAction($action)
    {
        ...
        if ((mb_strlen($action) < 1)) {
            throw new \InvalidArgumentException('invalid length for $action when calling InlineObject., must be bigger than or equal to 1.');
        }
    ...
    public function setUriDictionaryName($uri_dictionary_name)
    {
        if (!is_null($uri_dictionary_name) && (mb_strlen($uri_dictionary_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $uri_dictionary_name when calling InlineObject., must be smaller than or equal to 255.');
        }
        if (!is_null($uri_dictionary_name) && (mb_strlen($uri_dictionary_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $uri_dictionary_name when calling InlineObject., must be bigger than or equal to 1.');
        }
    ...
    public function setResponseObjectName($response_object_name)
    {
        if (!is_null($response_object_name) && (mb_strlen($response_object_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $response_object_name when calling InlineObject., must be smaller than or equal to 255.');
        }
        if (!is_null($response_object_name) && (mb_strlen($response_object_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $response_object_name when calling InlineObject., must be bigger than or equal to 1.');
        }

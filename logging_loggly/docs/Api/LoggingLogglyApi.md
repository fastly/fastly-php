...
```php
createLogLoggly($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token): \OpenAPI\Client\Model\InlineObject
```
...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_loggly_name = log-endpoint-name; // string
...
```php
getLogLoggly($service_id, $version_id, $logging_loggly_name): \OpenAPI\Client\Model\InlineObject
```
...
```php
listLogLoggly($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```
...
```php
updateLogLoggly($service_id, $version_id, $logging_loggly_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $token): \OpenAPI\Client\Model\InlineObject1
```

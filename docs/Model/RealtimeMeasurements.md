...
**compute_ram_used** | **int** | The amount of RAM used for your site by Fastly, including a maximum indicating the highest usage within this timeframe and a static cap for usage. | [optional]
...
**compute_requests** | **int** | The total number of requests that were received for your site by Fastly. | [optional]

...
[**\OpenAPI\Client\Model\ModelLoggingFtp**](../Model/ModelLoggingFtp.md)
...
$service_id = 'service_id_example'; // string
$version_id = 56; // int
$logging_ftp_name = 'logging_ftp_name_example'; // string
...
```php
getLogFtp($service_id, $version_id, $logging_ftp_name): \OpenAPI\Client\Model\ModelLoggingFtp
```
...
```php
listLogFtp($service_id, $version_id): \OpenAPI\Client\Model\ModelLoggingFtp[]
```

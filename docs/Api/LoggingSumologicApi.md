...
```php
createLogSumologic($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $url): \OpenAPI\Client\Model\ModelLoggingSumologic
```
...
[**\OpenAPI\Client\Model\ModelLoggingSumologic**](../Model/ModelLoggingSumologic.md)
...
$service_id = 'service_id_example'; // string
$version_id = 56; // int
$logging_sumologic_name = 'logging_sumologic_name_example'; // string
...
```php
getLogSumologic($service_id, $version_id, $logging_sumologic_name): \OpenAPI\Client\Model\ModelLoggingSumologic
```
...
```php
listLogSumologic($service_id, $version_id): \OpenAPI\Client\Model\ModelLoggingSumologic[]
```
...
```php
updateLogSumologic($service_id, $version_id, $logging_sumologic_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $placement, $format_version, $response_condition, $format, $message_type, $url): \OpenAPI\Client\Model\ModelLoggingSumologic
```

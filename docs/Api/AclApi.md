...
```php
createAcl($service_id, $version_id, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $id): \OpenAPI\Client\Model\ModelAcl
```
...
[**\OpenAPI\Client\Model\ModelAcl**](../Model/ModelAcl.md)
...
$service_id = 'service_id_example'; // string
$version_id = 56; // int
$acl_name = 'acl_name_example'; // string
...
```php
getAcl($service_id, $version_id, $acl_name): \OpenAPI\Client\Model\ModelAcl
```
...
```php
listAcls($service_id, $version_id): \OpenAPI\Client\Model\ModelAcl[]
```
...
```php
updateAcl($service_id, $version_id, $acl_name, $created_at, $deleted_at, $updated_at, $service_id2, $version, $name, $id): \OpenAPI\Client\Model\ModelAcl
```

...
$service_id = SU1Z0isxPaozGVKXdv0eY; // string
$version_id = 1; // int
$logging_elasticsearch_name = log-endpoint-name; // string
...
```php
getLogElasticsearch($service_id, $version_id, $logging_elasticsearch_name): \OpenAPI\Client\Model\InlineObject
```
...
```php
listLogElasticsearch($service_id, $version_id): \OpenAPI\Client\Model\InlineResponse200[]
```

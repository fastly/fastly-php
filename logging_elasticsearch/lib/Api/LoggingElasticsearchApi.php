...
class LoggingElasticsearchApi
{
     ...
     * @param  string $format A Fastly [log format string](https://docs.fastly.com/en/guides/custom-log-formats). Must produce valid JSON that Elasticsearch can ingest. (optional, default to '%h %l %u %t "%r" %&gt;s %b')
     ...
     */
    public function updateLogElasticsearch($service_id, $version_id, $logging_elasticsearch_name, $created_at = null, $deleted_at = null, $updated_at = null, $service_id2 = null, $version = null, $name = null, $placement = null, $format_version = FORMAT_VERSION_2, $response_condition = null, $format = '%h %l %u %t "%r" %&gt;s %b', $tls_ca_cert = 'null', $tls_client_cert = 'null', $tls_client_key = 'null', $tls_hostname = 'null', $request_max_entries = 0, $request_max_bytes = 0, $index = null, $url = null, $pipeline = null, $user = null, $password = null)
    {
